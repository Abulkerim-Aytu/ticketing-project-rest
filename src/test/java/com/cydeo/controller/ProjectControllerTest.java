...
//    These variables are static because we are going to use them in static @BeforeAll methods.
    static String token;

    static UserDTO manager;
    static ProjectDTO project;

//    Here we create our Sample DATA for testing
    @BeforeAll
    static void setUp() {
...
//  Most of the time we are NOT going to use structure like this.
    private static String getToken() {
        ...
        map.add("client_secret", "jLxFep0uT2hbDONzOHIaB1TfAHHVzhhX");
